...
class _SettingPageState extends State<SettingPage> {
  ...
  void addlistview() {
    ...
    listlvmenu.add(MenuSettingList(2, 'assets/moon.png', "Display & accessibility"));
  }
                        ...
                        children: [
                            ...
                            child: SizedBox(
                              ...
                              child: ListView.builder(
                                ...
                                itemBuilder: (BuildContext context, int index) {
                                  ...
                                  return ListTile(
                                    tileColor: selectedIndex == index ? theme.onBackground : null,
                                    onTap: () {
                                      onchange(index);
                                      setState(() {
                                        itemnow = objkey;
                                    ...
                                    leading: ImageIcon(AssetImage(objkey.icon),
                                        color: selectedIndex == index ? theme.background : theme.onPrimary),
                          ...
                          Expanded(
                            ...
                            child: Container(
                                ...
                                margin: const EdgeInsets.only(left: 10.0, right: 15.0, bottom: 15),
